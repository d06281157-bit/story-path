       ...
       <div className="px-6 -mt-10 relative z-10">
            <div className="bg-white rounded-3xl p-6 shadow-md space-y-6">
                ...
                <div className="space-y-2 text-center border-b border-gray-100 pb-4">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 font-serif">{place.title}</h1>
                ...
                <div className="space-y-4">
                     ...
                     <p className="text-gray-600 text-sm leading-7 text-justify">
                         Situated in {place.location}, this destination offers a unique blend of experiences. 
                         Whether you're looking for {place.tags[0].toLowerCase()} or simply want to escape the city, 
                         {place.title} provides the perfect backdrop for your story.
                         The local atmosphere is filled with {place.tags[1].toLowerCase()}, making it a must-visit 
                         for anyone traveling through Taiwan.
                     </p>
                </div>
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                    {place.tags.map(tag => (
                        <div key={tag} className="flex items-center gap-1 bg-gray-50 text-gray-500 px-3 py-1 rounded-md text-xs">
                            <Tag size={10} />
                            {tag}
                        </div>
                    ))}
