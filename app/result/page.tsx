...
function ResultContent() {
  ...
  // Chart Data
  const data = [
    { subject: '老街', A: scores.OldStreet, fullMark: 4 },
    { subject: '自然', A: scores.Nature, fullMark: 4 },
    { subject: '文化', A: scores.Culture, fullMark: 4 },
    { subject: '生活', A: scores.Lifestyle, fullMark: 4 },
  ];
        ...
        <div className="p-8 space-y-6">
            ...
            <div className="text-center space-y-2">
                ...
                <div className="flex justify-center gap-2 pt-2">
                   {/* Mock tags based on dimension */}
                   {resultDimension === 'OldStreet' && <span className="text-[10px] bg-white border border-gray-200 px-2 py-1 rounded-full text-gray-500">#時光隧道</span>}
                   {resultDimension === 'Nature' && <span className="text-[10px] bg-white border border-gray-200 px-2 py-1 rounded-full text-gray-500">#山海療癒</span>}
                   {resultDimension === 'Culture' && <span className="text-[10px] bg-white border border-gray-200 px-2 py-1 rounded-full text-gray-500">#知性深度</span>}
                   {resultDimension === 'Lifestyle' && <span className="text-[10px] bg-white border border-gray-200 px-2 py-1 rounded-full text-gray-500">#人情味</span>}
                </div>
            </div>
